...
const data = {
    ...
    linkedin: '#',
    leetcode: '#',
    summary: 'Highly skilled and detail-oriented software developer with 2 years of experience designing, developing, and deploying enterprise-level applications. Proficient in multiple programming languages, software development methodologies, and database management systems. Strong problem-solving skills and ability to work effectively in a team-based environment.',
    skills: {
        soft: ['Public Speaking', 'Leadership', 'Critical thinking', 'Team work'],
        hard: ['Problem Solving', 'Intermediate Coding', 'Object Oriented Programming', 'Application Development'],
        technology: ['HTML', 'CSS', 'Javascript', 'Google Cloud', 'React.js', 'Advance Node.js', 'MongoDB', 'MySQL']
    },
    internships: [
        {
    ...
    experience: [
        {
            ...
            badgeLink: '#',
            description: 'Building RESTful APIs (Node.js) from scratch, Testing, Staging and Deploying them on different cloud service providers. Implementing Unit Testing, also hosting informative and tech events based on APIs and Node.js to teach the students and spread API literacy.'
        },
        {
            position: 'MERN Stack',
            company: '',
    ...
    projects: [
        {
            ...
            description: 'Project facilitates knowledge sharing & career guidance among students. Incorporates strong user interaction and efficient doubt resolution.'
        },
        {
            name: 'Password Manager App',
            technology: '(Advance Node.js, MongoDB, Cryptography)',
            description: 'Password management project ensures secure storage using cryptography, bcrypt encryption, and decryption methods for enhanced data protection and user privacy.'
        },
        {
