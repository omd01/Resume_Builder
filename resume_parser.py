...
pytesseract.pytesseract.tesseract_cmd = r'/usr/bin/tesseract'  # Update with your Tesseract-OCR installation path

def pdf_to_images(pdf_path):
    images = pdf2image.convert_from_path(pdf_path, dpi=300)  # Specify the DPI
    return images
